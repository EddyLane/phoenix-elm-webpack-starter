defmodule ElmElixirWorkshop.SessionController do
  @moduledoc false

  use ElmElixirWorkshop.Web, :controller

  alias ElmElixirWorkshop.User
  alias ElmElixirWorkshop.UserQuery
  ...
  def new(conn, params) do
    ...
    render(conn, ElmElixirWorkshop.SessionView, "new.html", changeset: changeset)
  end
